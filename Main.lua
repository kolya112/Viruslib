...
layout:addChild(GUI.text(8, 8, 0x4B4B4B, localization.infolibs))
layout:addChild(GUI.text(9, 9, 0x4B4B4B, "-"))
layout:addChild(GUI.text(10, 10, 0x4B4B4B, localization.infoapps))
layout:addChild(GUI.text(11, 11, 0x4B4B4B, "Solaris virus | KKosty4ka"))
layout:addChild(GUI.text(12, 12, 0x4B4B4B, "ScramDisk - ORIGINAL | KKosty4ka"))
layout:addChild(GUI.text(13, 13, 0x4B4B4B, ""))
layout:addChild(GUI.text(14, 14, 0x4B4B4B, ""))
